...
export const run: execute = async (client) => {
  ...
  if (!dataforpresence.activities[0].url) {
    client.user.setPresence({
      ...
      activities: [
        { name: nameforactivity, type: dataforpresence.activities[0].type },
      ],
    });
    ...
    client.user.setPresence({
      ...
      activities: [
        {
          name: nameforactivity,
          type: dataforpresence.activities[0].type,
          url: dataforpresence.activities[0].url,
        },
      ],
    });
  }
